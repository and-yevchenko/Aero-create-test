    ...
    return (
        <div className='create-test-page'>
            <div className='create-test-page__container'>
                <Header>
                    {forms.length > 0 &&
                    <Link to={'/show-test'} className='create-test-page__button'>show test</Link>
                    }
                </Header>
                ...
                {!formItem.openSettings &&
                    <FormCreation {...formItem} />
                }
                
                <CreatePanel {...shuffleCards} open={modalWindow.onOpen} forms={forms} />
